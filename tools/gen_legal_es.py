...
PRIVACY_ES='''
  ...
  <section id="drip">
  <h3>Drip</h3>
  <p>Drip guarda los servicios que registras —nombre, coste, ciclo de cobro, fechas de pago, categoría, etiquetas, notas y etiqueta del método de pago— <strong>en tu dispositivo</strong>, en un contenedor de App Group privado compartido solo con los widgets de inicio y pantalla de bloqueo de Drip y sus atajos de Siri. Drip no tiene sistema de cuentas, ni compras dentro de la app, ni analítica, ni código de terceros que reciba tus datos.</p>
