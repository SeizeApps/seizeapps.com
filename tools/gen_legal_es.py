...
PRIVACY_ES='''
  ...
  <section id="kover">
  <h3>Kover</h3>
  <p>Kover guarda los productos que añades —nombre, categoría, tienda, fecha e importe de compra, país, fechas de garantía, número de serie, contacto de soporte, notas y la foto del ticket— <strong>en tu dispositivo</strong>, en el contenedor privado de la app. Kover no tiene sistema de cuentas, ni compras dentro de la app, ni analítica, ni código de terceros que reciba tus datos.</p>
