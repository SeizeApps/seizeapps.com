...
PRIVACY_ES='''
  ...
  <p class="effective">En vigor desde el 16 de septiembre de 2026</p>
  ...
  <h2>Quiénes somos</h2>
  <p>Seize Apps es un estudio independiente de aplicaciones que llevan <strong>Izotz Cristobal Mota</strong> y <strong>Sendoa Sola</strong> desde el País Vasco (España) («nosotros»). Esta política cubre todas las apps de Seize distribuidas a través de la App Store de Apple y TestFlight: actualmente <a href="#cycle-timers">Cycle Timers</a>, <a href="#tempo">Tempo</a>, <a href="#drip">Drip</a>, <a href="#anchor">Anchor</a>, <a href="#kover">Kover</a> y <a href="#tandem">Tandem</a>. Cada app la publica en la App Store uno de los dos: el vendedor que figura en su ficha es el responsable del tratamiento de esa app, y se nombra en su sección. Si una app difiere en algo, su sección es la que manda.</p>
  ...
  <p>Las compras las procesa íntegramente Apple. Recibimos de App Store Connect estadísticas agregadas y anónimas de ventas y fallos (por ejemplo, el número de descargas por país). Esas estadísticas no contienen identificadores personales.</p>
  ...
  <ul>
    ...
    <li><strong>En tu iCloud.</strong> Nuestras apps sincronizan a través de tu cuenta personal de iCloud, bajo las condiciones de Apple, salvo que lo desactives en Ajustes; nosotros nunca tenemos acceso.</li>
  </ul>
  ...
  <section id="tempo">
  <h3>Tempo</h3>
  <p>Tempo guarda tus sesiones de trabajo, el objetivo diario, las zonas de trabajo, los logros y las notas de comidas <strong>en tu dispositivo</strong>, en un contenedor de App Group privado compartido solo con los widgets y la Live Activity de la propia app. Tempo no tiene sistema de cuentas, ni analítica, ni código de terceros que reciba tus datos.</p>
  <p><strong>Ubicación.</strong> Tempo funciona por completo en modo manual sin ningún permiso de ubicación. Si decides dibujar una zona de trabajo, Tempo pide acceso a la ubicación y usa las geocercas de Apple, en el propio dispositivo, para notar cuándo llegas a esa zona y cuándo sales. La ubicación se procesa en el teléfono, nunca se sube a ningún sitio y no se usa para nada más que empezar y terminar tus sesiones de trabajo. Puedes quitar la zona y el permiso cuando quieras.</p>
  <p><strong>La sincronización con iCloud</strong> viene activada para que tus registros te sigan entre tus dispositivos a través de tu cuenta personal de iCloud, bajo las condiciones de Apple; nosotros nunca tenemos acceso. Si la desactivas en Ajustes, tus datos se quedan solo en el dispositivo. La exportación al calendario escribe en un calendario que tú eliges, en tu dispositivo, y solo cuando lo pides. Los recordatorios son notificaciones locales.</p>
  <p><em>Publicada en la App Store por Izotz Cristobal Mota.</em></p>
  </section>

  <section id="drip">
  <h3>Drip</h3>
  <p>Drip guarda los servicios que registras —nombre, coste, ciclo de cobro, fechas de pago, categoría, etiquetas, notas y etiqueta del método de pago— <strong>en tu dispositivo</strong>, en un contenedor de App Group privado compartido solo con los widgets de inicio y pantalla de bloqueo de Drip y sus atajos de Siri. Drip no tiene sistema de cuentas, ni analítica, ni código de terceros que reciba tus datos. Sí tiene un bote de propinas opcional: compras sueltas que no desbloquean nada ni cambian nada de la app. Las procesa Apple; nosotros no vemos tus datos de pago y no guardamos nada de ellas más allá de una cuenta local de cuántas veces has dejado propina.</p>
  ...
  <section id="kover">
  <h3>Kover</h3>
  <p>Kover guarda los productos que añades —nombre, categoría, tienda, fecha e importe de compra, país, fechas de garantía, número de serie, contacto de soporte, notas y la foto del ticket— <strong>en tu dispositivo</strong>, en el contenedor privado de la app. Kover no tiene sistema de cuentas, ni analítica, ni código de terceros que reciba tus datos. Sí tiene un bote de propinas opcional: compras sueltas que no desbloquean nada ni cambian nada de la app. Las procesa Apple; nosotros no vemos tus datos de pago y no guardamos nada de ellas más allá de una cuenta local de cuántas veces has dejado propina.</p>
