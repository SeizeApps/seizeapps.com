...
PRIVACY_ES='''
  ...
  <h2>Quiénes somos</h2>
  <p>Seize Apps es un estudio independiente de aplicaciones que llevan <strong>Izotz Cristobal Mota</strong> y <strong>Sendoa Sola</strong> desde el País Vasco (España) («nosotros»). Esta política cubre todas las apps de Seize distribuidas a través de la App Store de Apple y TestFlight: actualmente <a href="#cycle-timers">Cycle Timers</a>, <a href="#tempo">Tempo</a>, <a href="#drip">Drip</a>, <a href="#anchor">Anchor</a>, <a href="#kover">Kover</a>, <a href="#tandem">Tandem</a> y <a href="#meso">Meso</a>. Cada app la publica en la App Store uno de los dos: el vendedor que figura en su ficha es el responsable del tratamiento de esa app, y se nombra en su sección. Si una app difiere en algo, su sección es la que manda.</p>
